...
consolidated_from:
  - {
      date: "2026-05-06T09:48:44.914Z",
      path: architecture/opencode/byterover_plugin_curation_and_recall.sync-conflict-20260503-134830-QVX6PJM.md,
      reason: "These are duplicate representations of the same Byterover plugin curation/recall review note. The sync-conflict files repeat the same facts, rules, examples, and validation details as the canonical markdown file.",
    }
  - {
      date: "2026-05-06T09:48:44.914Z",
      path: architecture/opencode/byterover_plugin_curation_and_recall.sync-conflict-20260503-134835-QVX6PJM.md,
      reason: "These are duplicate representations of the same Byterover plugin curation/recall review note. The sync-conflict files repeat the same facts, rules, examples, and validation details as the canonical markdown file.",
    }
---
