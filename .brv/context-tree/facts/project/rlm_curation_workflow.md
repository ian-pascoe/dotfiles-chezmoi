---
consolidated_at: '2026-05-27T11:28:01.685Z'
consolidated_from: [{date: '2026-05-27T11:28:01.685Z', path: facts/project/rlm_curation_workflow.abstract.md, reason: Abstract and full version describe the same workflow; merging keeps the richer full file.}]
---
...
## Raw Concept
**Task:** Curate the session instructions for RLM‑based context curation.
...
**Flow:** recon already computed → single‑pass decision → curate directly → verify applied file paths
...
*(All original sections, rules, and additional preserved convention details are retained verbatim.)